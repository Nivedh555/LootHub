...
/** Official Discord logo mark (svgl.app). */
...
/**
 * Discord-branded call-to-action button that opens the community server
 * in a new tab. Uses Discord's official blurple + logo mark.
 */
export function DiscordButton({
  ...
  return (
    ...
    >
      <DiscordMark className={size === "lg" ? "h-5 w-6" : "h-4 w-5"} />
      {label}
    </Link>
  );
}
