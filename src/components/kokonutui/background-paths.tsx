      ...
      >
        ...
        <defs>
          <linearGradient id="sharedGradient" x1="0%" x2="100%" y1="0%" y2="0%">
            {/* Re-themed to LootHub purple (original pink/blue stops removed per brand rules) */}
...
// Exported for LootHub: lets us layer the animated paths behind our own
// hero content instead of using the component's full-screen demo layout.
